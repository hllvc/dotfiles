...
return {
	{
		...
		keys = {
			...
			-- find
			{ "<leader>fc", telescope("find_files", { cwd = vim.fn.stdpath("config") }), desc = "Find Config File" },
			{
				"<leader>ff",
				telescope("files"),
			...
			{ "<leader>sl", "<cmd>Telescope loclist<cr>", desc = "Location List" },
			{
				...
				telescope("find_files", {
					cwd = vim.fn.stdpath("config") .. "/spell",
					prompt_title = "Spellfiles",
