# Generated by Powerlevel10k configuration wizard on 2022-01-06 at 14:06 CET.
...
() {
  ...
  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Show kuecontext only when the the command you are typing invokes one of these tools.
  # Tip: Remove the next line to always show kubecontext.
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k|kk|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud|gcs|gsutil|gcsfuse'
  # Google cloud color.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='%3F%B${P9K_GCLOUD_CONFIGURATION}/${P9K_GCLOUD_PROJECT_ID//\%/%%} %k%F(${P9K_GCLOUD_ACCOUNT})'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_GCLOUD_VISUAL_IDENTIFIER_EXPANSION='%fat'
